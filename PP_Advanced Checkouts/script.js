...
let reset_purchase_button = () => {
  document
    ...
    .removeAttribute("disabledk");
  document
    .querySelector("#card-form")
    .querySelector("input[type='submit']").value = "Purchase";
};
...
const client_id =
  "AfmP_Jzao4tPRb-nMDg4R5Y0eEaM9wYNaktzbEqFzH7d2kk4ykYXDIDyJ0v6mSkMJXfvl3ik27V-zNSn";
const currency = "USD";
  ...
  .then((client_token) => {
    ...
    return script_to_head({
      src:
        ...
        "&intent=" +
        intent +
        "&components=messages,buttons,hosted-fields",
            ...
            card_fields
              .submit(
                ...
                //be a requirement of your project to pass this info to card issuers
                {
                  ...
                  cardholderName: "Aneri Dalwadi",
                  // Billing Address
                  billingAddress: {
                    // Street address, line 1
                    streetAddress: "123 San Antonio St",
